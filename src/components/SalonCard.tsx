...
const SalonCard: React.FC<SalonCardProps> = ({ salon }) => {
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-[#D4AF37]/20">
      ...
      <div className="p-4">
        <h3 className="text-lg font-bold text-[#1E1E1E] mb-1">{salon.name}</h3>
        <p className="text-sm text-gray-600 mb-3">{salon.description}</p>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            <span className="text-[#D4AF37] mr-1">★</span>
            <span className="font-semibold text-[#1E1E1E]">{salon.rating}</span>
